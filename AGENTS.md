...
- GitHub Actions cron is UTC and routinely delayed 1-6 hours; the 1-hour DST shift is negligible compared to scheduling jitter, so a single cron per workflow is sufficient
